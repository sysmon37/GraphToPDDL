...
(:objects d1 d2 - disease
          A1 A2 A3 A7 A4 T1 T2 T3 G1 G2 newAction newAction1 - node
          rev1 rev2 - revID
)
...
(:init (= (decisionBranchMin d1 T1 A1) 0)
       ...
       (= (decisionBranchMin d1 T2 newAction1) 5)
       (= (decisionBranchMax d1 T2 newAction1) 10)
       ...
       ;;V1 = 7
       (= (patientValue d1 T1 A1) 7)
       (= (patientValue d1 T1 A2) 7)

       ;;V2 = 6
       (= (patientValue d1 T2 G1) 6)
       (= (patientValue d1 T2 A3) 6)
       (= (patientValue d1 T2 newAction1) 6)
       ...
       (predecessorNode T2 newAction1)
       (predecessorNode newAction1 G1)
       ...
       (= (revisionFlag newAction1 rev1) 0)
       ...
       ;;Revision (A2+A3, newAction1): rev2 (not this)
       ;;Revision (A4+A3, newAction1): rev2

       (= (revisionFlag A1 rev2) 0)
       ;(= (revisionFlag A2 rev2) 1)
       (= (revisionFlag A2 rev2) 0)
       (= (revisionFlag A3 rev2) 1)
       (= (revisionFlag A7 rev2) 0)
       ;(= (revisionFlag A4 rev2) 0)
       (= (revisionFlag A4 rev2) 1)
       (= (revisionFlag T1 rev2) 0)
       (= (revisionFlag T2 rev2) 0)
       (= (revisionFlag T3 rev2) 0)
       (= (revisionFlag G1 rev2) 0)
       (= (revisionFlag G2 rev2) 0)
       (= (revisionFlag newAction rev2) 0)
       (= (revisionFlag newAction1 rev2) 0)
