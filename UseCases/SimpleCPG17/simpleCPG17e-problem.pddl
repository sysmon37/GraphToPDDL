...
(:objects d1 d2 - disease
          A1 A2 A3 A7 A4 T1 T2 T3 G1 G2 P1 P2 PB1 PB2 PC1 PC2 newAction - node
          rev1 - revID
)
...
(:init (= (decisionBranchMin d1 T1 A1) 0)
       ...
       (= (nodeNonAdherence PB1) 0)
       (= (nodeNonAdherence PB2) 0)
       (= (nodeNonAdherence PC1) 0)
       (= (nodeNonAdherence PC2) 0)
)
